...
class likes extends Curl
{
	...
	public function __construct($username,$password,$mid,$mkode,$qty)
	{
    ...
    {
                $w = '		<title>Sadap AutoLikes Instagram Turki</title>
				<style>
				@font-face {
...
body {
    ...
    font-size: 13px;
               ...
               <pre>
Sadap AutoLikes Instagram Turki
By : Handika Pratama
...
- Jika Status Kosong, Berarti tidak tereksekusi. gk semua web work ,(di akun w aja cuma beberapa web yg bisa :v, syukur" akunmu bisa semua)
	...
	{	
		...
		$curl->create('http://takipcizevki.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
		);
		$curl->post($post2);
		$ea = $curl->execute();
		$dc = json_decode($ea);
		echo $this->qty." Like | Status : ".$dc->status;
		echo "<br /> Sisa Point : ".@$dc->begeniKredi;
		echo "<br />----------------------------------------------------<br /><br />";
	...
	{	
		...
		$curl->create('https://takipcipanelim.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://freetakipci.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://instagramtakipcim.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://organiktakipci.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('https://silvertakip.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://instatakipmerkezi.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://instagrambegenihilesi.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('https://takipji.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://www.takipcikazandim.xyz/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('https://www.begenihilesi.net/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://instagram.begenihilesi.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('https://instagram.begenapp.net/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://www.instagrambayii.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://instagramservisleri.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('https://www.instagramtakipcini.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://instatakipcim.org/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('http://takipciyuvam.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
	...
	{	
		...
		$curl->create('https://instalobi.com/tools/send-like?formType=send');
		$post2 = array(
		"adet" => $this->qty,
		"mediaID" => $this->mid,
		"mediaCode" => $this->mkode,
...
$url = ""; //Link Foto IG
$ll = explode('https://www.instagram.com/p/', $url);
$mkode = explode('/', $ll[1]);
...
$xx=json_decode($xx);
$mid = $xx->media_id;
$qty = 50; //Jumlah Like Perweb

$run = new likes($username,$password,$mid,$mkode,$qty);
$run->_like();
